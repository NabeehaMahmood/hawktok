    ...
    >
      <div className="container mx-auto relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-gray-300 text-base md:text-lg lg:text-xl mt-6 max-w-3xl mx-auto">
        ...
        {/* Two Column Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 max-w-6xl mx-auto mb-12 md:mb-16">
          {/* Column 1 */}
        ...
        {/* Ticker */}
  <div className="relative z-20 mt-16 md:mt-32 overflow-hidden bg-black py-8 md:py-[0.25in] border-t border-b border-gray-700">
        <div
          ...
          {Array.from({ length: 100 }).map((_, i) => {
            ...
            return (
              <img
                ...
                src={logo.src}
                alt={logo.name}
                className={`inline-block ${isSmall ? 'h-12 md:h-[0.7in]' : 'h-16 md:h-[1in]'} object-contain mr-8 md:mr-16`}
              />
            );
          })}
        </div>
